...
==============================================================
Run this script once to generate `../models/loan_model.pkl`.
...
DEFAULT_MODEL_PATH = str(Path(__file__).resolve().parent.parent.parent / "models" / "loan_model.pkl")
...
def train_and_save(output_path: str = DEFAULT_MODEL_PATH):
